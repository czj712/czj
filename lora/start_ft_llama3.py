...
merged_model_id = "/home/ubuntu/outputs/llama3_merged"
model = AutoModelForCausalLM.from_pretrained(merged_model_id,device_map={"":0}, trust_remote_code=True, torch_dtype=torch.bfloat16,)
